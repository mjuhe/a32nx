...
use super::{CabinFlowProperties, OutflowValveActuator};
...
impl PressureValve {
    ...
    pub fn calculate_outflow_valve_position<T: OutflowValveActuator>(
        ...
        self.target_open = actuator.target_valve_position(press_overhead, cabin_simulation);
    }
